...
class TestVersionMetadata:
    ...
    def test_age_calculation(self):
        ...
        meta = VersionMetadata(
            content_id="doc_123",
            version="v1.0",
            retrieved_at=datetime.now(timezone.utc) - timedelta(seconds=60),
            source="api",
        )
    ...
    def test_is_stale_within_ttl(self):
        ...
        meta = VersionMetadata(
            content_id="doc_123",
            version="v1.0",
            retrieved_at=datetime.now(timezone.utc) - timedelta(seconds=30),
            source="api",
            ttl_seconds=60,
        )
    ...
    def test_is_stale_exceeded_ttl(self):
        ...
        meta = VersionMetadata(
            content_id="doc_123",
            version="v1.0",
            retrieved_at=datetime.now(timezone.utc) - timedelta(seconds=120),
            source="api",
            ttl_seconds=60,
        )
